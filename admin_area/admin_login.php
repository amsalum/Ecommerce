...
if (isset($_POST['admin_name'])) {
    ...
    $select_quary = "SELECT * from admin_data where admin_name='$admin_name'and admin_password='$password'";
        ...
        <div class="row">
            <div class="col-lg-12 col-xl-6 ">
                <form action="" method="post" class=" w-50 mx-auto my-5">
                    ...
                    <a href="password_reset.php" class="mx-5" name =" reset"> Forgot Password</a>
