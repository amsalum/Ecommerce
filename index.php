        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-info">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    // } else {
                    //     echo " <li class='nav-item'>
                    //     <a class='nav-link' href='./user_area/user_register.php'>User register</a>
                    // </li>";
                   // }
                    ?>

                    <li class="nav-item">
                        <a class="nav-link" href="./admin_area/contact.php">Contact</a>
                    </li>
                    <li class="nav-item">
       ...
       // cart();
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-secondary">
            <ul class="navbar-nav me-auto">
                ...
                <li class="text-center  mx-5 ">
                    <a href="./admin_area/admin_login.php " class="mx-5 text-light"  style="text-decoration: none;"> Admin login</a>
                   </li>
            </ul>
